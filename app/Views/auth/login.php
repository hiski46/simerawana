<form action="login" method="post" accept-charset="utf-8">
  ...
  <div class="form-floating">
    <input type="email" class="form-control text-light" id="identity" name="identity" placeholder="name@example.com" autocomplete="off">
    <label class="text-light bordered" for="identity" name="identity"><?= lang('Auth.login_identity_label') ?></label>
  </div>
  <div class="form-floating">
    <input type="password" class="form-control text-light" id="password" name="password" placeholder="Password" autocomplete="off">
